...
public class PinpadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        findViewById(R.id.btnKey0).setOnClickListener(this::keyClick);
        findViewById(R.id.btnKey1).setOnClickListener(this::keyClick);
        findViewById(R.id.btnKey2).setOnClickListener(this::keyClick);
        findViewById(R.id.btnKey3).setOnClickListener(this::keyClick);
        findViewById(R.id.btnKey4).setOnClickListener(this::keyClick);
        findViewById(R.id.btnKey5).setOnClickListener(this::keyClick);
        findViewById(R.id.btnKey6).setOnClickListener(this::keyClick);
        findViewById(R.id.btnKey7).setOnClickListener(this::keyClick);
        findViewById(R.id.btnKey8).setOnClickListener(this::keyClick);
        findViewById(R.id.btnKey9).setOnClickListener(this::keyClick);
    }
